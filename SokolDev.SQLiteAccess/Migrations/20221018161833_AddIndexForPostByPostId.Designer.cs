...
namespace SokolDev.SQLiteAccess.Migrations
{
    ...
    [Migration("20221018161833_AddIndexForPostByPostId")]
    partial class AddIndexForPostByPostId
    {
            ...
            modelBuilder.Entity("SokolDev.DataAccess.Entities.Post", b =>
                {
                    ...
                    b.HasIndex("PostId")
                        .HasDatabaseName("PostIdIndex");

                    b.ToTable("Posts");
                });

            modelBuilder.Entity("SokolDev.DataAccess.Entities.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
